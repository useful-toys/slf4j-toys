...
- Classes modified/generated by AI must include: `@author Co-authored-by: <AI Name> using <model>`, naming the actual assistant and model that generated the change — not a fixed placeholder tool name
- Example (Claude Code): `@author Co-authored-by: Claude Code using Claude Sonnet 5`
- If GitHub Copilot specifically generated the change, use `@author Co-authored-by: GitHub Copilot using <model name>` instead — see `.github/copilot-instructions.md`
