 ...
 */
public class Slf4JoverJulExample_pureJul2 {

    public static final Logger logger = LoggerFactory.getLogger("example");

    static {
        System.setProperty("java.util.logging.config.file",
                Slf4JoverJulExample_pureJul2.class.getClassLoader().getResource("log.properties").getFile());
        LoggerConfig.hackJulEnable = true;
        LoggerConfig.hackJulReplaceSource = true;
