...
public class MessageHighlightConverter extends ForegroundCompositeConverterBase<ILoggingEvent> {
    ...
    static {
        ...
        MARKER_MAP.put(Markers.UNEXPECTED_EXCEPTION, ERROR_VISIBILITY);
        MARKER_MAP.put(Markers.INVALID_TRANSITION, ERROR_VISIBILITY);
        MARKER_MAP.put(Markers.INVALID_STATE, ERROR_VISIBILITY);
        MARKER_MAP.put(Markers.INVALID_EXCEPTION, ERROR_VISIBILITY);
        MARKER_MAP.put(Markers.INVALID_ARGUMENT, ERROR_VISIBILITY);
    }
