...
public class WatcherJavaxServlet extends HttpServlet {
    ...
    public void init(final ServletConfig config) throws ServletException {
        ...
        LOGGER.info("WatcherJavaxServlet initialized with watcher name '{}'.", resolvedName);
    }
    ...
    private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (watcherName != null) {
            ...
            LOGGER.info("WatcherJavaxServlet watcher '{}' recreated after deserialization.", watcherName);
        }
    }
