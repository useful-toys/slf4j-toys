 ...
 * </ul>
 * <p>
 * <b>Note on Coverage:</b> Code generated by Lombok (constructors, getters, setters, etc.) is automatically
 * excluded from coverage reports via the {@code lombok.addLombokGeneratedAnnotation=true} configuration in
 * {@code lombok.config}. JaCoCo version 0.8.2+ automatically ignores methods annotated with {@code @Generated}
 * or {@code @lombok.Generated}.
 *
...
class LoggerFactoryTest {
    ...
    // Note: The private constructor generated by @UtilityClass is excluded from coverage
    // via lombok.config setting: lombok.addLombokGeneratedAnnotation=true
    // This causes Lombok to add @lombok.Generated annotation which JaCoCo automatically excludes
}
